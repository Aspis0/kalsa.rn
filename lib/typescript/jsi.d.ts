...
declare global {
    ...
    var llamaQueueCompletion: (contextId: number, params: NativeParallelCompletionParams, onToken: (token: any, requestId: number) => void, onComplete: (result: any) => void) => Promise<{
        requestId: number;
    }>;
