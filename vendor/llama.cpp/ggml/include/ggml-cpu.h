...
extern "C" {
    ...
    // Setter wins; GGML_MOE_FUSED_GEMV is read only if the setter is never called.
    GGML_BACKEND_API void ggml_cpu_set_moe_fused_gemv(bool enabled);
    GGML_BACKEND_API bool ggml_cpu_get_moe_fused_gemv(void);
    ...
    // unfused graph. Setter wins; GGML_MOE_FUSED_FFN is read only if the setter
    // is never called.
    GGML_BACKEND_API void ggml_cpu_set_moe_fused_ffn(bool enabled);
    GGML_BACKEND_API bool ggml_cpu_get_moe_fused_ffn(void);
